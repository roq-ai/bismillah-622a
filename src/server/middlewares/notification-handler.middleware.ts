...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order Placed.create': {
    roles: ['administrator', 'team-member', 'sales-manager', 'customer-service-representative'],
    key: 'order_placed',
    tenantPath: [],
    userPath: [],
  },
  'Support Ticket Opened.create': {
    roles: ['administrator', 'team-member', 'customer-service-representative'],
    key: 'support_ticket_opened',
    tenantPath: [],
    userPath: [],
  },
  'Sales Lead Created.create': {
    roles: ['administrator', 'team-member', 'sales-manager'],
    key: 'sales_lead_created',
    tenantPath: [],
    userPath: [],
  },
};
