  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to BISMILLAH, your comprehensive CRM SaaS software solution designed to streamline your customer relationship management processes, elevate your business, and empower your growth."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1585974738771-84483dd9f89f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxDUk18ZW58MHx8fHwxNjk2NjE1ODEyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@gabrielbenois?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Gabriel Benois`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to BISMILLAH, your comprehensive CRM SaaS software solution designed to streamline your customer relationship management processes, elevate your business, and empower your growth.`}
            </Text>
            <Box
